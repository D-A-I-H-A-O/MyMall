<template>
  <el-dialog
    ...
    <el-form-item label="登录类型[1-com.daihao.mall.product.web，2-app]" prop="loginType">
      <el-input v-model="dataForm.loginType" placeholder="登录类型[1-com.daihao.mall.product.web，2-app]"></el-input>
    </el-form-item>
    </el-form>
    ...
    data () {
      return {
        ...
        dataRule: {
          ...
          loginType: [
            { required: true, message: '登录类型[1-com.daihao.mall.product.web，2-app]不能为空', trigger: 'blur' }
          ]
        }
      }
    },
